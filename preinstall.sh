...
sed -e "s/password/$silo_password/g" preinstall.sql > tmp_preinstall.sql && mv -f tmp_preinstall.sql preinstall.sql
mysql -u$user -p < preinstall.sql
sed -e "s/$silo_password/password/g" preinstall.sql > tmp_preinstall.sql && mv -f tmp_preinstall.sql preinstall.sql
